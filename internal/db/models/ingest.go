...
type Ingest struct {
	...
	MediaMetadata *MediaMetadata `bson:"mediaMetadata,omitempty" json:"mediaMetadata,omitempty"`
	InstallTarget *string        `bson:"installTarget,omitempty" json:"installTarget,omitempty"`
